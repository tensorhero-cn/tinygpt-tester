...
func e05GptAndGenerateTestCase() tester_definition.TestCase {
	return tester_definition.TestCase{
		Slug:        "gpt-and-generate",
		Timeout:     60 * time.Second,
		TestFunc:    testE05GptAndGenerate,
		CompileStep: autoCompileStep("TestE05", "test_e05"),
	}
}

func testE05GptAndGenerate(harness *test_case_harness.TestCaseHarness) error {
