...
func e01TokenizationTestCase() tester_definition.TestCase {
	return tester_definition.TestCase{
		Slug:        "tokenization",
		Timeout:     30 * time.Second,
		TestFunc:    testE01Tokenization,
		CompileStep: autoCompileStep("TestE01", "test_e01"),
	}
}

func testE01Tokenization(harness *test_case_harness.TestCaseHarness) error {
