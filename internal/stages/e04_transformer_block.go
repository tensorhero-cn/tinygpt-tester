...
func e04TransformerBlockTestCase() tester_definition.TestCase {
	return tester_definition.TestCase{
		Slug:        "transformer-block",
		Timeout:     30 * time.Second,
		TestFunc:    testE04TransformerBlock,
		CompileStep: autoCompileStep("TestE04", "test_e04"),
	}
}

func testE04TransformerBlock(harness *test_case_harness.TestCaseHarness) error {
