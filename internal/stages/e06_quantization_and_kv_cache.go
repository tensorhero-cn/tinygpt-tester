...
func e06QuantizationAndKVCacheTestCase() tester_definition.TestCase {
	return tester_definition.TestCase{
		Slug:        "quantization-and-kv-cache",
		Timeout:     30 * time.Second,
		TestFunc:    testE06QuantizationAndKVCache,
		CompileStep: autoCompileStep("TestE06", "test_e06"),
	}
}

func testE06QuantizationAndKVCache(harness *test_case_harness.TestCaseHarness) error {
