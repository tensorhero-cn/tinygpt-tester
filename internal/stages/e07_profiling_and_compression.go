...
import (
	...
	"github.com/tensorhero-cn/tinygpt-tester/internal/helpers"
)

func e07ProfilingAndCompressionTestCase() tester_definition.TestCase {
	return tester_definition.TestCase{
		Slug:        "profiling-and-compression",
		Timeout:     30 * time.Second,
		TestFunc:    testE07ProfilingAndCompression,
		CompileStep: autoCompileStep("TestE07", "test_e07"),
	}
}

func testE07ProfilingAndCompression(harness *test_case_harness.TestCaseHarness) error {
