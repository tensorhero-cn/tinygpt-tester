...
SOLUTION_DIR="${TESTER_DIR}/../tinygpt-solution"
STARTER_DIR="${TESTER_DIR}/../tinygpt-starter"
...
for lang in "${LANGUAGES[@]}"; do
    ...
    for stage in "${STAGES[@]}"; do
        ...
        if ./tinygpt-tester -d="$sol_dir" -s="$stage" > /dev/null 2>&1; then
